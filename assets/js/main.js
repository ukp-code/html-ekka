...
function ecCheckCookie() {
    ...
    if ("" != ecAccessCookie("darkModeCookie")) {
        ...
        "" != a &&
            ...
            "01" != a && $("link[href='assets/css/responsive.css']").before('<link rel="stylesheet" href="assets/css/skin-' + a + '.css" rel="stylesheet">'));
    }
}
!(function (g) {
    "use strict";
    ecCheckCookie(),
        ...
        new (function ({ offset: b } = { offset: 10 }) {
            ...
            return (
                (c = document.querySelectorAll("[data-animation]:not([data-animated])")),
    ...
    $(window).on("scroll", function () {
        ...
        $(document).ready(function () {
            $(".ec-sidebar-slider-cat .ec-sb-pro-sl").slick({
                ...
                autoplaySpeed: 8e3,
                responsive: [
                    { breakpoint: 992, settings: { rows: 4, slidesToShow: 1, slidesToScroll: 1, dots: !1 } },
                    { breakpoint: 479, settings: { rows: 4, slidesToShow: 1, slidesToScroll: 1, dots: !1 } },
                ],
            });
        }),
        $(function () {
            $(".insta-auto, .cat-auto").infiniteslide({ direction: "left", speed: 50, clone: 10 }), $('[data-toggle="tooltip"]').tooltip();
        }),
        ...
        (b = $(".ec-menu-content, .overlay-menu")).find(".sub-menu").parent().prepend('<span class="menu-toggle"></span>'),
        b.on("click", "li a, .menu-toggle", function (b) {
            var a = $(this);
            ("#" === a.attr("href") || a.hasClass("menu-toggle")) &&
                (b.preventDefault(),
                a.siblings("ul:visible").length
                    ? (a.parent("li").removeClass("active"), a.siblings("ul").slideUp(), a.parent("li").find("li").removeClass("active"), a.parent("li").find("ul:visible").slideUp())
        ...
        $(".qty-product-cover").slick({ slidesToShow: 1, slidesToScroll: 1, arrows: !1, fade: !1, asNavFor: ".qty-nav-thumb" }),
        $(".qty-nav-thumb").slick({ slidesToShow: 4, slidesToScroll: 1, asNavFor: ".qty-product-cover", dots: !1, arrows: !0, focusOnSelect: !0, responsive: [{ breakpoint: 479, settings: { slidesToScroll: 1, slidesToShow: 2 } }] }),
    ...
    d.prepend('<div class="dec ec_qtybtn">-</div>'),
        ...
        $.scrollUp({ scrollText: '<i class="ecicon eci-arrow-up" aria-hidden="true"></i>', easingType: "linear", scrollSpeed: 900, animation: "fade" }),
        $("#ec-fs-count-1").countdowntimer({ startDate: "2021/10/01 00:00:00", dateAndTime: "2023/01/01 00:00:00", labelsFormat: !0, displayFormat: "DHMS" }),
        $("#ec-fs-count-2").countdowntimer({ startDate: "2021/10/01 00:00:00", dateAndTime: "2022/12/01 00:00:00", labelsFormat: !0, displayFormat: "DHMS" }),
        $("#ec-fs-count-3").countdowntimer({ startDate: "2021/10/01 00:00:00", dateAndTime: "2022/11/01 00:00:00", labelsFormat: !0, displayFormat: "DHMS" }),
        $("#ec-fs-count-4").countdowntimer({ startDate: "2021/10/01 00:00:00", dateAndTime: "2023/03/01 00:00:00", labelsFormat: !0, displayFormat: "DHMS" }),
        $(".ec-fre-products").slick({ rows: 1, dots: !1, arrows: !0, infinite: !0, speed: 500, slidesToShow: 1, slidesToScroll: 1 }),
        $(".ec-spe-products").slick({ rows: 1, dots: !1, arrows: !0, infinite: !0, speed: 500, slidesToShow: 1, slidesToScroll: 1 }),
        $(".ec-change-color").on("click", "li", function () {
            ...
            if (!$(this).hasClass("active"))
                return (
                    ...
                    void 0 != a && ($("link[href='assets/css/responsive.css']").before('<link rel="stylesheet" href="assets/css/skin-' + a + '.css" rel="stylesheet">'), ecCreateCookie("themeColorCookie", a, 1)),
                    !1
                );
        }),
        $(".ec-tools-sidebar .ec-change-rtl .ec-rtl-switch").click(function (a) {
            ...
            $(this).parent().hasClass("ec-change-rtl") && $(this).parent().hasClass("active")
                ? (b.appendTo("head"), ecCreateCookie("rtlModeCookie", "rtl", 1))
                : $(this).parent().hasClass("ec-change-rtl") && !$(this).parent().hasClass("active") && ($("link.rtl").remove(), ecDeleteCookie("rtlModeCookie", "ltr"));
        }),
        $(".ec-tools-sidebar .ec-change-mode .ec-mode-switch").click(function (b) {
            ...
            $(this).parent().toggleClass("active");
            var a = "light";
            $(this).parent().hasClass("ec-change-mode") && $(this).parent().hasClass("active")
                ? $("link[href='assets/css/responsive.css']").before(c)
                : $(this).parent().hasClass("ec-change-mode") && !$(this).parent().hasClass("active") && ($("link.dark").remove(), (a = "light")),
                $(this).parent().hasClass("active")
                    ? ($("#ec-fixedbutton .ec-change-color").css("pointer-events", "none"), $("body").addClass("dark"), ecCreateCookie("darkModeCookie", (a = "dark"), 1))
                    : ($("#ec-fixedbutton .ec-change-color").css("pointer-events", "all"), $("body").removeClass("dark"), ecDeleteCookie("darkModeCookie", a));
        }),
    ...
    $(window).on("load", function () {
        ...
        $("#ec-testimonial-slider").slick({ rows: 1, dots: !0, arrows: !1, centerMode: !0, infinite: !1, speed: 500, centerPadding: 0, slidesToShow: 1, slidesToScroll: 1 }),
        ...
        $(document).ready(function () {
            $(".ec-more-toggle").click(function () {
                "More Categories" == $(".ec-more-toggle #ec-more-toggle").text()
                    ? ($(".ec-more-toggle #ec-more-toggle").text("Less Categories"), $(".ec-more-toggle").toggleClass("active"), $("#ec-more-toggle-content").slideDown())
                    : ($(".ec-more-toggle  #ec-more-toggle").text("More Categories"), $(".ec-more-toggle").removeClass("active"), $("#ec-more-toggle-content").slideUp());
            });
        }),
        $(document).ready(function () {
        ...
        $(".single-product-cover").slick({ slidesToShow: 1, slidesToScroll: 1, arrows: !1, fade: !1, asNavFor: ".single-nav-thumb" }),
        $(".single-nav-thumb").slick({ slidesToShow: 4, slidesToScroll: 1, asNavFor: ".single-product-cover", dots: !1, arrows: !0, focusOnSelect: !0 }),
        $("#ec-single-countdown").countdowntimer({ startDate: "2021/10/01 00:00:00", dateAndTime: "2023/01/01 00:00:00", labelsFormat: !0, displayFormat: "DHMS" }),
        $(document).ready(function () {
    ...
    if (a) {
        ...
        noUiSlider.create(a, { start: [e, f], connect: !0, step: l, range: { min: e, max: f }, format: { to: (a) => a, from: (a) => a } }),
    ...
    function x(a, b) {
        $("body").removeClass("body-bg-1"),
            ...
            $("body").removeClass("body-bg-4"),
            $("body").addClass(b),
            $("#bg-switcher-css").attr("href", "assets/css/backgrounds/" + a + ".css"),
            ecCreateCookie("bgImageModeCookie", a + "||" + b, 1);
    }
    $(".cart-qty-plus-minus").append('<div class="ec_cart_qtybtn"><div class="inc ec_qtybtn">+</div><div class="dec ec_qtybtn">-</div></div>'),
        ...
        $(document).ready(function () {
            $(".ec-list").on("click", function () {
                ...
                /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)
                    ...
                    : window.open("https://web.WhatsApp.com/send?phone=" + a + "&text=" + b, "-blank");
            }),
        ...
        ($.fn.launchBtn = function (e) {
            ...
            (a = $(".ec-button")),
                (b = $(".ec-panel")),
                (f = 0),
                (g = $.extend({ openDuration: 600, closeDuration: 200, rotate: !0 }, e)),
                (h = function () {
                ...
                (c = function (a) {
                    return (
                        0 === f ? (g.rotate && $(this).removeClass("rotateBackward").toggleClass("rotateForward"), h(), f++) : (g.rotate && $(this).removeClass("rotateForward").toggleClass("rotateBackward"), i(), f--),
                        a.preventDefault(),
                        !1
                    );
                }),
            ...
            return (
                ...
                $(this).hasClass("in-out")
                    ? ($(".bg-switcher").stop().animate({ right: "0px" }, 100),
                      $(".color-option-box").not("in-out") && ($(".skin-switcher").stop().animate({ right: "-163px" }, 100), $(".color-option-box").addClass("in-out")),
                      $(".layout-option-box").not("in-out") && ($(".layout-switcher").stop().animate({ right: "-163px" }, 100), $(".layout-option-box").addClass("in-out")))
            ...
            return (
                ...
                $(this).hasClass("in-out")
                    ? ($(".ec-tools-sidebar").stop().animate({ right: "0px" }, 100),
                      ...
                      $(".ec-tools-sidebar-toggle").not("in-out") && ($(".ec-tools-sidebar").stop().animate({ right: "-200px" }, 100), $(".ec-tools-sidebar-toggle").addClass("in-out")),
                      $(".ec-tools-sidebar-toggle").not("in-out") && ($(".ec-tools-sidebar").stop().animate({ right: "0" }, 100), $(".ec-tools-sidebar-toggle").addClass("in-out"), $(".ec-tools-sidebar-overlay").fadeIn()))
                    : ($(".ec-tools-sidebar").stop().animate({ right: "-200px" }, 100), $(".ec-tools-sidebar-overlay").fadeOut()),
                $(this).toggleClass("in-out"),
                !1
            );
        }),
        ...
        g(document).ready(function (a) {
            ...
            a.ajax({
                ...
                data: { google_where: file_name, google_url: b, google_font: c, google_version: "EKKA-HTML-TEMPLATE-AK" },
                success: function (b) {
                    a("body").append(b);
                },
            });
